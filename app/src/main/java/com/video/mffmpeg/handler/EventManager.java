...
public class EventManager
{
    ...
    //    public static final int MediaPlayerInit = 0;
    ...
    public static final int MediaPlayerInit = 0x102;
    ...
    public static final int MediaPlayerDead = 0x113;
    
    // 275 /* add item for "INPUT_EVENT_DEAD" defined in vlc_input.h 20121110*/
    ...
    {
        Log.d("EventManager", "callback----->event = " + event  + "  mEventHandler.size()=" + mEventHandler.size());
        for (int i = 0; i < mEventHandler.size(); i++)
        {
            Log.d("EventManager", "callback----->for   i= " + i);
            Message msg = Message.obtain();
            msg.what = event;
            if (mEventHandler.get(i) != null)
